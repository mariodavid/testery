...
public class TesteryTestContainer extends TestContainer {

    public TesteryTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/testery/app.properties",
    ...
    public static class Common extends TesteryTestContainer {

        public static final TesteryTestContainer.Common INSTANCE = new TesteryTestContainer.Common();
